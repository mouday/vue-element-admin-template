...
export const area_list = [
  {
    ...
    label: '国内',
    count: 0,
    children: inProvinces
  },
  {
    value: '1',
    label: '国外',
    count: 0,
    children: outProvinces
  }
]
